...
export const BOARD_THEMES: Record<string, BoardTheme> = {
  ...
  // NOTE: the image-skin themes (board_steampunk, board_celtic, board_medieval,
  // board_darkwood, board_tokyo, board_cyber2) from frontend/ were deliberately
  // dropped from this standalone copy — their pre-rendered board/checker image
  // assets total ~166MB, disproportionate for a proof-of-concept app. The
  // flat-color themes below need no image assets at all.
